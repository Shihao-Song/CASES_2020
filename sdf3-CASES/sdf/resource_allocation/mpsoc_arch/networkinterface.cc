 ...
 *
 * $Id: networkinterface.cc,v 1.1.1.1.2.1 2010-04-25 02:08:51 mgeilen Exp $
 *
...
namespace SDF
{
                                          ...
                                          const double inBandwidth, const double outBandwidth)
    {
        ...
        maxVals[nrConn] = (double) nrConnections;
            ...
            const double outBandwidth)
    {
        ...
        {
            std::cerr << "[ERROR] Not enough connections." << std::endl;
            return false;
        }
        ...
        {
            std::cerr << "[ERROR] Not enough input bandwidth." << std::endl;
            return false;
        }
        ...
        {
            std::cerr << "[ERROR] Not enough output bandwidth." << std::endl;
            return false;
        }

        // Create component binding
        b = new ComponentBinding(c, 3);
        b->setValue(nrConn, (double) nrConnections);
